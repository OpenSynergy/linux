...
static int virtio_video_dec_s_fmt(struct virtio_video_stream *stream,
...
static int virtio_video_dec_s_fmt_vid_cap(struct file *file, void *fh,
					  struct v4l2_format *f)
{
	return virtio_video_dec_s_fmt(file2stream(file), f);
}

static int virtio_video_dec_s_fmt_vid_out(struct file *file, void *fh,
					  struct v4l2_format *f)
{
	return virtio_video_dec_s_fmt(file2stream(file), f);
}
